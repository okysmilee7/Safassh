...
data_ip="https://raw.githubusercontent.com/okysmilee7/Permission/main/ip"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/okysmilee7/Permission/main/ip"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    git remote add origin https://github.com/okysmilee7/Permission
    git push -f https://${TOKEN}@github.com/okysmilee7/Permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
